...
excuses = [
    ...
    "your monitor resolution was too high",
    "improperly oriented keyboard",
    "network packets travelling uphill (use of a carrier pigeon)",
    ...
    "disk's spinning backwards",
    "too few computrons available",
    "the military using communications satellites for star wars",
    ...
    # "Server's depressed, needs Prozac",
    # "quantum decoherence",
    # "those damn raccoons!",
