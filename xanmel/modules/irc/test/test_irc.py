...
def test_channel_message_action(xanmel, mocker, log_effect):
    mocker.patch.object(xanmel, 'setup_event_generators')
    xanmel.load_modules()
    irc_module = xanmel.modules['xanmel.modules.irc.IRCModule']
    send = mocker.patch.object(irc_module.client, 'send')
    send.side_effect = log_effect
...
def test_channel_messages_action(xanmel, mocker, log_effect):
    mocker.patch.object(xanmel, 'setup_event_generators')
    xanmel.load_modules()
    irc_module = xanmel.modules['xanmel.modules.irc.IRCModule']
    send = mocker.patch.object(irc_module.client, 'send')
...
def test_private_message_action(xanmel, mocker, log_effect):
    mocker.patch.object(xanmel, 'setup_event_generators')
    xanmel.load_modules()
    irc_module = xanmel.modules['xanmel.modules.irc.IRCModule']
    send = mocker.patch.object(irc_module.client, 'send')
...
def test_private_messages_action(xanmel, mocker, log_effect):
    mocker.patch.object(xanmel, 'setup_event_generators')
    xanmel.load_modules()
    irc_module = xanmel.modules['xanmel.modules.irc.IRCModule']
    send = mocker.patch.object(irc_module.client, 'send')
...
def test_mention_message_handler(xanmel, mocker, log_effect):
    mocker.patch.object(xanmel, 'setup_event_generators')
    xanmel.load_modules()
    irc_module = xanmel.modules['xanmel.modules.irc.IRCModule']
